...
pub fn register_toolchain(
    ...
    Ok(Json(RegisterToolchainOutput {
        ...
        config_file_globs: vec!["poetry.toml".into()],
        exe_names: vec!["poetry".into()],
        manifest_file_names: vec!["pyproject.toml".into()],
        lock_file_names: vec!["poetry.lock".into()],
        ..Default::default()
    }))
}
...
pub fn define_toolchain_config() -> FnResult<Json<DefineToolchainConfigOutput>> {
    Ok(Json(DefineToolchainConfigOutput {
        schema: SchemaBuilder::build_root::<PoetryToolchainConfig>(),
    }))
}
